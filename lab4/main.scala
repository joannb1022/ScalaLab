...
package p11 {
  private[p1] class C1 {
    ...
    override def equals(other: Any): Boolean = other match {
      ...
      // && (this.a12 == that.a12) // (1) ---> value a12 is not a member od p1.p11.C1
      case _ => false
    }
  }
}
package p12 {
  ...
  class C12 extends C1 {
    ...
    // def mC122() { print("[mC122]: "); super.privP11MC1() } // (2) ---? methos privP11MC1 in class C2 cannot be accessed in p1.p11.C1
  }
}
object Appl {
...
//pelna nazwa klasy - public final class p1.Applbean
